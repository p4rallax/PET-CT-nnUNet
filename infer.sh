...
nnUNetv2_predict -d Dataset703_FS_SCGH_Train -f 0 1 2 3 4 -tr nnUNetTrainer -c 3d_fullres_resenc -p nnUNetPlans -i /nnUNet_raw_data_base/Dataset703_FS_SCGH_Train/imagesTs -o /data/nnunet_out/

nii_file=$(find "/data/nnunet_out" -type f -name "*.nii.gz")
cp "$nii_file" "/data/output/$output_file"